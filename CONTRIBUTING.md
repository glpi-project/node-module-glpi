...
Before submitting the issue please check the [issue tracker](https://github.com/glpi-project/node-module-glpi/issues), there exists the possibility that the bug was already reported by other contributor.
...
You can file new issues by filling out our [new issue form](https://github.com/glpi-project/node-module-glpi/issues/new).
...
* In GitHub, send a pull request to our [Repository](https://github.com/glpi-project/node-module-glpi).
...
This is the command you must run to test your contribution:
